                ...
                <div class="card-body">
                    ...
                    <div class="position-relative mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <ul class="chart-legend clearfix">
                                    <li><i class="far fa-circle" style="color: #d4c148"></i> Ilmu Syariah</li>
                                    <li><i class="far fa-circle" style="color: #ff990a"></i> Ilmu Bahasa</li>
                                    <li><i class="far fa-circle" style="color: #00a352"></i> Ilmu Al Qur'an</li>
                                </ul>
                            </div>
                        </div>
                    </div>
