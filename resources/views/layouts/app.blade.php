...
<body class="hold-transition login-page"
    ...
    @error('id_card')
        <script>
            toastr.error("Maaf User ini tidak terdaftar sebagai Guru Mahad Fityanul Ulum!");
        </script>
    @enderror
    @error('guru')
        <script>
    ...
    @error('no_induk')
        <script>
            toastr.error("Maaf User ini tidak terdaftar sebagai Siswa Guru Mahad Fityanul Ulum!");
        </script>
    @enderror
    @error('siswa')
        <script>
